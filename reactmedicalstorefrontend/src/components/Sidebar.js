        ...
        return (
            <section>
                <aside id="leftsidebar" className="sidebar">
                    ...
                    <div className="menu">
                        <div className="slimScrollDiv" style={{position: "relative", overflow: "hidden", width: "auto", height: "57px"}}><ul className="list" style={{overflow: "hidden", width: "auto", height: "57px"}}>
